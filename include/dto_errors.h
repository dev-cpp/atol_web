...
//! Минимальный код ошибки
#define EC_LESSER_SCALE_ERROR       EC_SCALE_BAD_TARE_WEIGHT
...
//! Отчет о состоянии отчетов прерван. Устраните неисправность и повторите печать отчета
...
#define BC_LESSER_FPTR_PARAM        BC_SETTINGSTRING
//! @}
